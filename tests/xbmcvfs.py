...
def translatePath(path):
    ...
    if path.startswith('special://home'):
        return path.replace('special://home', str(basedir/'tests') + '/')
    if path.startswith('special://masterprofile'):
        return path.replace('special://masterprofile', str(basedir/'tests/userdata') + '/')
    if path.startswith('special://profile'):
        return path.replace('special://profile',  str(basedir/'tests/userdata') + '/')
    if path.startswith('special://userdata'):
        return path.replace('special://userdata',  str(basedir/'tests/userdata') + '/')
    return path
