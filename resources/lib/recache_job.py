...
progress.create("video.drnu re-caching")
progress.update(0)

used_time = api.recache_requests(cache_urls=False, cache_episodes=True,
                                 clear_expired=False, verbose=True, progress=progress)
